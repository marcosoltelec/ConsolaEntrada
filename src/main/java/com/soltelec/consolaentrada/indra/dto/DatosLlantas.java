 ...
 * @author usurio
 */
public class DatosLlantas {

    private String operarioLlantas = "";
    private String noIdentificacionOpLlantas = "";
    ...
    private String izqPresionexterneEje2 = "";
    ...
    public String getOperarioLlantas() {
        return operarioLlantas;
    }

    public void setOperarioLlantas(String operarioLlantas) {
        this.operarioLlantas = operarioLlantas;
    }

    public String getNoIdentificacionOpLlantas() {
        return noIdentificacionOpLlantas;
    }

    public void setNoIdentificacionOpLlantas(String noIdentificacionOpLlantas) {
        this.noIdentificacionOpLlantas = noIdentificacionOpLlantas;
    }
    ...
    public void setIzqPresionEje1(String izqPresionEje1) {
        this.izqPresionEje1 = izqPresionEje1;
    }

    public String getIzqPresionexterneEje2() {
        return izqPresionexterneEje2;
    }

    public void setIzqPresionexterneEje2(String izqPresionexterneEje2) {
        this.izqPresionexterneEje2 = izqPresionexterneEje2;
    }
    ...
    public void setIzqPresionExternaEje3(String IzqPresionExternaEje3) {
        this.IzqPresionExternaEje3 = IzqPresionExternaEje3;
    }
    ...
    public void setIzqPresionExternaEje4(String IzqPresionExternaEje4) {
        this.IzqPresionExternaEje4 = IzqPresionExternaEje4;
    }
    ...
    public void setIzqPresionExternaEje5(String IzqPresionExternaEje5) {
        this.IzqPresionExternaEje5 = IzqPresionExternaEje5;
    }
    ...
    public void setIzqPresionInternaEje2(String IzqPresionInternaEje2) {
        this.IzqPresionInternaEje2 = IzqPresionInternaEje2;
    }
    ...
    public void setIzqPresionInternaEje3(String IzqPresionInternaEje3) {
        this.IzqPresionInternaEje3 = IzqPresionInternaEje3;
    }
    ...
    public void setIzqPresionInternaEje4(String IzqPresionInternaEje4) {
        this.IzqPresionInternaEje4 = IzqPresionInternaEje4;
    }
    ...
    public void setIzqPresionInternaEje5(String IzqPresionInternaEje5) {
        this.IzqPresionInternaEje5 = IzqPresionInternaEje5;
    }
    ...
    public void setRepuestoPresion(String RepuestoPresion) {
        this.RepuestoPresion = RepuestoPresion;
    }
    ...
    public void setRepuesto2Presion(String Repuesto2Presion) {
        this.Repuesto2Presion = Repuesto2Presion;
    }

    @Override
    public String toString() {
        return operarioLlantas + ";"
                + noIdentificacionOpLlantas + ";"
                + derProfundidadEje1 + ";"
                + derProfundidadExternaEje2 + ";"
                + derProfundidadExternaEje3 + ";"
                + derProfundidadExternaEje4 + ";"
                + derProfundidadExternaEje5 + ";"
                + izqProfundidadEje1 + ";"
                + izqProfundidadExternaEje2 + ";"
                + izqProfundidadExternaEje3 + ";"
                + izqProfundidadExternaEje4 + ";"
                + izqProfundidadExternaEje5 + ";"
                + derProfundidadInternaEje2 + ";"
                + derProfundidadInternaEje3 + ";"
                + derProfundidadInternaEje4 + ";"
                + derProfundidadInternaEje5 + ";"
                + izqProfundidadInternaEje2 + ";"
                + izqProfundidadInternaEje3 + ";"
                + izqProfundidadInternaEje4 + ";"
                + izqProfundidadInternaEje5 + ";"
                + repuestoProfundidad + ";"
                + Repuesto2Profundidad + ";"
                + derPresionEje1 + ";"
                + derPresionExternaEje2 + ";"
                + derPresionExternaEje3 + ";"
                + derPresionExternaEje4 + ";"
                + derPresionExternaEje5 + ";"
                + izqPresionEje1 + ";"
                + izqPresionexterneEje2 + ";"
                + IzqPresionExternaEje3 + ";"
                + IzqPresionExternaEje4 + ";"
                + IzqPresionExternaEje5 + ";"
                + derPresionInternaEje2 + ";"
                + derPresionInternaEje3 + ";"
                + derPresionInternaEje4 + ";"
                + derPresionInternaEje5 + ";"
                + IzqPresionInternaEje2 + ";"
                + IzqPresionInternaEje3 + ";"
                + IzqPresionInternaEje4 + ";"
                + IzqPresionInternaEje5 + ";"
                + RepuestoPresion + ";"
                + Repuesto2Presion;
    }
